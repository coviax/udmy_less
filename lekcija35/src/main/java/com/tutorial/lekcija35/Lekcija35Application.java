package com.tutorial.lekcija35;
...
import com.tutorial.lekcija35.repository.ProductRepository;

@SpringBootApplication
public class Lekcija35Application implements CommandLineRunner {

	private ProductRepository productRepository;

	private Logger LOG = LoggerFactory.getLogger(Lekcija35Application.class);
	...
	public static void main(String[] args) {
		SpringApplication.run(Lekcija35Application.class, args);
	}
	...
	public void run(String... arg0) throws Exception {
		...
		if(foundProduct != null) {
			...
			LOG.info("Broj proizvoda: " + productRepository.count());
			productRepository.delete(foundProduct);
			LOG.info("Proizvod obrisan!");

			LOG.info("Broj proizvoda nakon brisanja: " + productRepository.count());
		...
		if (productToUpdate != null) {
			productToUpdate.setName("Updated proizvod");
